...
public class FilterNoteBook {
    ...
    public static Set<NoteBook> filterByRam(Set<NoteBook> notebooks, int minRam, int maxRam) {
        ...
        System.out.printf("минимальный объем оперативной памяти %s и максимальный %s установлен", minRam, maxRam);
        return filtered;
    }
    ...
    public static Set<NoteBook> filterByStorage(Set<NoteBook> notebooks, int minStorage, int maxStorage) {
        ...
        System.out.printf("минимальный объем жесткого диска %s и максимальный %s установлен", minStorage, maxStorage);
        return filtered;
    }
    ...
    public static Set<NoteBook> filterByDiagonal(Set<NoteBook> notebooks, double minDiagonal, double maxDiagonal) {
        ...
        System.out.printf("минимальная диагональ экрана %s и максимальная диагональ экрана %s установлена", minDiagonal, maxDiagonal);
        return filtered;
    }
